...
$LastAdded = $db->select("*", "product")->limit(10)->get_all();
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <a href="<?php echo URL . "?p=" . $Last["Url"] ?>">
                                            <img src="<?php echo URL ?>/images/products/<?php echo $Last["Cover"] ?>" alt="" />
                                        </a>
                                        <h2><?php echo $Last["Price"] ?> TL</h2>
                                        <p><?php echo $Last["Name"] ?></p>
